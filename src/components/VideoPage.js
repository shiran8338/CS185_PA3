        ...
        <div>
            ...
            <div className="grid_container">
                <div className="grid_item">
                    <img src={video1} onClick={() => spawnOverlay(1)} />
                </div>
                ...
                <div className="grid_item">
                    <img className="video_thumbnail" src={video2} onClick={() => spawnOverlay(2)} />
                </div>
                ...
                <div className="grid_item">
                    <img className="video_thumbnail" src={video3} onClick={() => spawnOverlay(3)} />
                </div>
                ...
                <div className="grid_item">
                    <img className="video_thumbnail" src={video4} onClick={() => spawnOverlay(4)} />
                </div>
                ...
                <div className="grid_item">
                    <img className="video_thumbnail" src={video5} onClick={() => spawnOverlay(5)} />
                </div>
